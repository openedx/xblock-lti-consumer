...
def lti_1p3_enabled():
    ...
    """
    return settings.FEATURES.get('LTI_1P3_ENABLED', True) is True  # pragma: no cover
...
def lti_deeplinking_enabled():
    ...
    """
    return settings.FEATURES.get('LTI_DEEP_LINKING_ENABLED', True) is True  # pragma: no cover
...
def lti_nrps_enabled():
    ...
    """
    return settings.FEATURES.get('LTI_NRPS_ENABLED', True)  # pragma: no cover
